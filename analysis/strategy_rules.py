...
def write_html(report: dict, path: Path, csv_path: Path) -> None:
    ...
    *{box-sizing:border-box}body{margin:0}main{max-width:1500px;margin:auto;padding:30px 22px 60px}
    ...
    <div class="rule"><strong>Protect two socks per person.</strong><br>Below this household active-stock ratio, a future day cannot dress everyone without replenishment. Between two and four, everyone may dress, but full four-sock hands cannot be guaranteed.</div>
